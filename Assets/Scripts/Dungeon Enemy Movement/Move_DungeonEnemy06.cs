...
public class Move_DungeonEnemy06 : MonoBehaviour
{
    ...
    void Start () {
        ...
        p1.transform.position = new Vector3(-30, 7, 155);
        points[0] = p1.transform;

        GameObject p2 = new GameObject("p2");
        p2.transform.position = new Vector3(-30, 7, 146);
        points[1] = p2.transform;

        GameObject p3 = new GameObject("p3");
        p3.transform.position = new Vector3(-30, 7, 155);
        points[2] = p3.transform;

        GameObject p4 = new GameObject("p4");
        p4.transform.position = new Vector3(-36, 7, 159);
