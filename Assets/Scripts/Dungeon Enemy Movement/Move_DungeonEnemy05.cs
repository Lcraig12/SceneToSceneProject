...
public class Move_DungeonEnemy05 : MonoBehaviour
{
    ...
    void Start () {
        ...
        p1.transform.position = new Vector3(-57, 7, 158);
        points[0] = p1.transform;

        GameObject p2 = new GameObject("p2");
        p2.transform.position = new Vector3(-52, 7, 159);
        points[1] = p2.transform;

        GameObject p3 = new GameObject("p3");
        p3.transform.position = new Vector3(-57, 7, 158);
        points[2] = p3.transform;

        GameObject p4 = new GameObject("p4");
        p4.transform.position = new Vector3(-59, 7, 144);
